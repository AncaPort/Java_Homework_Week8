...
public class Cylinder extends Circle {
    ...
    public Cylinder(double radius, double height) {//The class needs to have one constructor with two parameters radius and height both of type double.It needs to call the parent constructor and initialize a height field.
        // In case the height parameter is less than 0 it needs to set the height field value to 0.
        super(radius);
        this.height = (height < 0) ? 0 : height;
    }

    public double getHeight() {//Method named getHeight without any parameters, it needs to return the value of height field.
        return height;
    }

    public double getVolume() {//Method named getVolume without any parameters, it needs to return the calculated volume.
        //To calculate volume, multiply the area with height.
